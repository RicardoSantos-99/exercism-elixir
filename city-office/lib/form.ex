defmodule Form do
  ...
  @type address_map :: %{city: String.t(), postal_code: String.t(), street: String.t()}
  ...
  """
  @spec blanks([non_neg_integer() | non_neg_integer()]) :: String.t()
  def blanks(n) do
  ...
  """
  @spec format_address(address_map()) :: String.t()
